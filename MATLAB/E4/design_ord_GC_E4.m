function design_ord_GC_E4(subj_k)
%% Stimuli ordering script
    %{ 
        ...
        order. Is read with bhv_exp_GC_E4.
    %}
...
tuples_ordered = nchoosek(61:120, 2); % 1:60 for males, 61:120 for females
