function design_ord_GC_E2(subj_k) %[trial_ord_orig, trial_code_list, trial_list, lr_ind]

RandStream.setGlobalStream ...
    (RandStream('mt19937ar','seed',sum(100*clock)))

if nargin==0
    subj_k=4; %enter subject number
end
...
%cnd 1
        male_conv=single(conv(ord_gend, [1 1 1 1 1])>5);
        fem_conv=single(conv((1-ord_gend), [1 1 1 1 1])>5);
